...
pagelinkicon = '<img src="../favicon.ico">'

# ---------------------------------------------------------------------
# Less important personal preferences:

# sublistsize controls the maximum number of items that will appear as
...
def createpage(root, tree, p):
    ...
    with open(filename, 'w') as f:
        ...
        f.write('\n</p>')
        f.write("<i>This page automatically created by 'newslist' v. %s. on %s</i>\n" %
                (rcsrev, time.ctime()))
        f.write('</body>\n</html>\n')
